...
def experiment(env: str = 'kinodynamic_cup',
    ...
    for epoch in range(n_epochs):
        ...
        wandb.log({
            ...
            "Constraints_det_orientation/": {"avg": {str(i): a for i, a in enumerate(constraints_violation_det_mean[28:])},
                                             "max": {str(i): a for i, a in enumerate(constraints_violation_det_max[28:])}},
            "Stats/": {
