...
def env_builder(env_name, n_envs, env_params):
    ...
    if env_name == "air_hockey":
        ...
        #env_class = Gymnasium
        #env_params["name"] = "quad_insert_a0o0"
        #env_params["name"] = "quad_insert_constrained"
    ...
    #        "rl_info": env.info,
    #        "dt": env.info.dt,
    #        "episode_duration": env.info.horizon * env.info.dt,
    #        "robot": ...,
    #    }
    #if not hasattr(env_info, "rl_info"):
    #    env_info = {
    #        "rl_info": env.info
    #    }
    if n_envs > 1:
